...
public class LuosimaoDuanxinUtil {
    ...
    //短信平台的APIkey
    private static final String DUANXIN_API_KEY = "key-f8bf141b31c57aab04abd6a954958385";//需要使用自己的APIkey
    private static final String SPEAK_API_KEY = "key-6bd5fde5b3689e6ab1ae35693e6103df";//需要使用自己的APIkey
