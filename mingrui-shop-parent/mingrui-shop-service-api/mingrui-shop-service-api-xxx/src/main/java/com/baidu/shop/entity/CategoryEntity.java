...
public class CategoryEntity {
    ...
    @NotEmpty(message = "商品分类名不能为空",groups = {MingruiOperation.Update.class,MingruiOperation.Add.class})
    private String name;

    @ApiModelProperty(value = "父类id,顶级类目填0",example = "1")
    @NotNull(message = "父类分级id不能为空",groups = {MingruiOperation.Add.class})
